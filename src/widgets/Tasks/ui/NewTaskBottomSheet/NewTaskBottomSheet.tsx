...
export const NewTaskBottomSheet = () => {
  const theme = useTheme<AppTheme>();
  const visible = useTaskBottomSheetsStore((s) => s.newTaskBottomSheetVisible);
  const close = useTaskBottomSheetsStore((s) => s.closeNewTaskBottomSheet);
  ...
  return (
    ...
    >
      <BottomSheetView style={styles.contentContainer}>
        <Text style={styles.title}>{i18n.t('taskDialog.newTask.title')}</Text>
